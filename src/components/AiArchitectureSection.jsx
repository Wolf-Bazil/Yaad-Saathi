...
import { Cpu, Bot, Zap, ArrowRight, ShieldCheck, Clock, FileText } from 'lucide-react';
...
export default function AiArchitectureSection() {
  ...
  const reports = {
    ...
    as: {
      ...
      text: "শ্ৰীমতী কমলা দেৱীয়ে এই সপ্তাহত ৬ টা স্মৃতিচাৰণ অধিৱেশনত অংশগ্ৰহণ কৰে। শ্বিলঙৰ পৰিয়ালৰ ফটো চিনাক্তকৰণত কাৰ্যক্ষম স্মৃতিশক্তি ১২% বৃদ্ধি পাইছে। প্ৰতিক্ৰিয়াৰ সময় ২.১ ছেকেণ্ডত সুস্থিৰ আছিল। পুৱা ১০:০০ বজাৰ পৰা ১১:১৫ বজাৰ ভিতৰত মানসিক সজাগতা সৰ্বাধিক আছিল।"
    }
  };
            ...
            <div className="space-y-4">
              ...
              <div className="p-6 rounded-2xl bg-white border border-charcoal-200 shadow-elevation">
                ...
                <div className="mt-4 pt-3 border-t border-charcoal-100 flex items-center justify-between text-[10px] text-charcoal-500">
                  <span>Formatted for ASHA Sub-Centres & Families</span>
                  <span className="font-semibold text-emerald-700">✓ Ready to Export</span>
                </div>
              </div>
